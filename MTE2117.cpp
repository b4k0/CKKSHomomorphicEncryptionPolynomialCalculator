...
void example_ckks_basics()
{
    ...
    */
    ...
    cout << "Evaluating polynomial 3*x^2 + 0.4x + 1 ..." << endl;

    /*
    We create plaintexts for 3, 0.4, and 1 using an overload of CKKSEncoder::encode
    that encodes the given floating-point value to every slot in the vector.
    */
    Plaintext plain_coeff3, plain_coeff1, plain_coeff0;
    encoder.encode(3, scale, plain_coeff2);
    ...
    /*
    To compute 3*x^2 we first compute 1*x. Second, compute 3*x and last 3*x^2!
    */
    /*
    First we compute 1*x.
    */
    Ciphertext x2_encrypted;
    encryptor.encrypt(x_plain, x2_encrypted);
    print_line(__LINE__);
    cout << "Compute 1*x.:" << endl;
    eevaluator.multiply_plain_inplace(x2_encrypted, plain_coeff0);
    ...
    */
    ...
    the scale of 3*x^2 and 0.4*x to 2^40.
    */
    print_line(__LINE__);
